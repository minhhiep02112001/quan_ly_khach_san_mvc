<section class="content-header">
    ...
    <ol class="breadcrumb">
        <a href="/admin/customer" class="btn btn-success btn-sm" style="color: #fff">Danh sách nhân viên</a>
    </ol>
</section>
<!-- Main content -->
<?php
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <?php endif;?>
                <!-- form start -->
                <form role="form" action="/admin/customer/store" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <label>
                                <input type="checkbox" name="active"
                                       value="1" <?=isset($old['active']) ? 'checked' : ''?>> Kích hoạt
                            </label>
                        </div>
                    </div><!-- /.box-body -->
