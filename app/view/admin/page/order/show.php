            ...
            <table class="table table-striped">
                ...
                <?php foreach ($order_details as $item): ?>
                    <tr>
                        ...
                        <td class="text-center"><?= number_format($item['price'] * $order['sum_day'], 0, ',', '.') ?> đ</td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
                        ...
                        <form action="admin/order/update/<?=$order['id']?>" id="form-update-status" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="select-status-order" name="status">
                                    ...
                                    <option value="3"  <?= $order['status'] == 3 ? 'selected':"" ?> class="cancel-order"><?= getOrderStatus(3)?></option>
                                    <option value="4"  <?= $order['status'] == 4 ? 'selected':"" ?> class="cancel-order"><?= getOrderStatus(4)?></option>
                                </select>
                            </div>
