...
<!-- Mirrored from bookinghotel.mynukeviet.com/vi/users/login/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Oct 2021 14:45:08 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title></title>
    <base href="<?= WEB_ROOT ?>">
    <meta name="description" content="  Đăng nhập - Thành viên - http&#x3A;&#x002F;&#x002F;bookinghotel.mynukeviet.com&#x002F;vi&#x002F;users&#x002F;login&#x002F;" />
    ...
    <meta property="og:description" content="Thành viên đăng nhập - Đăng nhập - Thành viên - http&#x3A;&#x002F;&#x002F;bookinghotel.mynukeviet.com&#x002F;vi&#x002F;users&#x002F;login&#x002F;" />
                    ...
                    <div class="login-box">
                        <div class="page panel panel-default margin-top-lg box-shadow bg-lavender">
                            <div class="panel-body">
                                ...
                                <form action="<?= WEB_ROOT?>/login/post" method="post" >
                                    ...
                                    <div class="form-detail">
                                        <div class="form-group loginstep1">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="required form-control" placeholder="Tên đăng nhập hoặc email" value="<?= $old['email'] ??""?>" name="email" maxlength="100" data-pattern="/^(.){3,}$/" onkeypress="validErrorHidden(this);" data-mess="Tên đăng nhập chưa được khai báo">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group loginstep1">
                                            <div class="input-group">
                                                ...
                                                <input type="password" autocomplete="off" class="required form-control" placeholder="Mật khẩu" value="" name="password" maxlength="100" data-pattern="/^(.){3,}$/" onkeypress="validErrorHidden(this);" data-mess="Mật khẩu đăng nhập chưa được khai báo">
                                            </div>
                                        </div>
                                ...
                                <div class="text-center margin-top-lg" id="other_form">
                                    <a href="<?= WEB_ROOT?>/register" class="margin-right-lg"><em class="fa fa-caret-right margin-right-sm"></em>Đăng ký</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-16 col-sm-24 offset-4">
                    ...
                    <div id="contactButton">
                        ...
                        <div class="clearfix">
                            <div data-cs="1373a1becf9030b4aa877e6a662e4380"></div>
                        </div>
                    </div>
...
<div id="run_cronjobs" style="visibility:hidden;display:none;"><img alt="" src="http://bookinghotel.mynukeviet.com/index.php?second=cronjobs&amp;p=a0EI1f2B" width="1" height="1" /></div>
...
<div id="guestLogin_nv23" class="hidden">
    <div class="page panel panel-default bg-lavender box-shadow">
        <div class="panel-body">
            <h3 id="loginBarHandle" class="h3_login">
                <label for="LoginControl"><a href="#" class="OverlayTrigger concealed noOutline">Thành viên đăng nhập</a></label>
...
<script>var nv_base_siteurl="http://bookinghotel.mynukeviet.com/",nv_lang_data="vi",nv_lang_interface="vi",nv_name_variable="nv",nv_fc_variable="op",nv_lang_variable="language",nv_module_name="users",nv_func_name="login",nv_is_user=0, nv_my_ofs=7,nv_my_abbr="+07",nv_cookie_prefix="nv4",nv_check_pass_mstime=1738000,nv_area_admin=0,nv_safemode=0,theme_responsive=1,nv_is_recaptcha=0;</script>
...
<script>
    ( function(d, s, id) {
        ...
        js.id = id;
        js.src = "<?= WEB_ROOT?>/public/client/connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v2.6&appId=1813595862224723";
