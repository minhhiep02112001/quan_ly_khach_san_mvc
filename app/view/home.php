...
<!-- Mirrored from bookinghotel.mynukeviet.com/vi/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Oct 2021 14:34:20 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <title></title>
    <base href="<?= WEB_ROOT?>">
    <meta name="description" content="Website dành riêng cho hệ thống khách sạn trên toàn quốc." />
    ...
    <meta property="og:title" content="ATR Hotel" />
...
<div class="body-content " id="top-banner-and-menu">
                        ...
                        <div class='container'>
                            <div class='row'>
                                <div class='col-lg-24 animate'>
                                    <h2 class='big fadeInUp animated'>NGỌC HOA Hotel</h2>
                                    <p class='normal fadeInUp animated'>Sở hữu ưu thế vượt trội về vị trí và tiện ích nhưng NGỌC HOA Hotel lại có mức giá rất cạnh tranh so với những dự án căn hộ cho thuê khác trong khu vực. Căn hộ cao cấp nhưng sở hữu mức giá phù hợp với đông đảo khách hàng. Một căn hộ đáng đồng tiền cho khác</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class='item'>
                    <div class="img-item" style="background:url('./public/client/uploads/menu/pool_1500x720.jpg');background-size: cover">
                        <div class='container'>
                            <div class='row'>
                                <div class='col-lg-24 animate'>
                                    <h2 class='big fadeInUpBig animated'>Sự Chu Đáo</h2>
                                    <p class='normal fadeInUp animated'>Đường 10 mét thông thoáng. Ngọc Hoa Hotel có khả năng liên kết vùng tốt, nối liền các địa bàn quan trọng của thành phố nhờ được bao quanh bởi vô số cung đường huyết mạch khác như Võ thị sáu, Nam kỳ khởi ngĩa, Hai bà trưng…, hỗ trợ di chuyển thuận lợi và n</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class='item'>
                    <div class="img-item" style="background:url('./public/client/uploads/menu/berlingoldenbeach013.jpg');background-size: cover">
                        <div class='container'>
                            <div class='row'>
                                <div class='col-lg-24 animate'>
                                    <h2 class='big fadeInUp animated'>Sự Tiện Nghi</h2>
                                    <p class='normal fadeInUp animated'>Sở hữu ưu thế vượt trội về vị trí và tiện ích nhưng Ngọc Hoa Hotel lại có mức giá rất cạnh tranh so với những dự án căn hộ cho thuê khác trong khu vực. Căn hộ cao cấp nhưng sở hữu mức giá phù hợp với đông đảo khách hàng. Một căn hộ đáng đồng tiền cho khác</p>
                                </div>
                            </div>
                        </div>
                ...
                <li class='item'>
                    <div class="img-item" style="background:url('./public/client/uploads/menu/book-direct-and-save-20-sgd-banner.jpg');background-size: cover">
                        <div class='container'>
                            <div class='row'>
                                <div class='col-lg-24 animate'>
                                    <h2 class='big fadeInLeftBig animated'>Sự An Tâm</h2>
                                    <p class='normal fadeInUp animated'>Phòng tập GYM rộng thoáng mát, đầy đủ các dụng cụ tập chuyên nghiệp...</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container p-l0 p-r0">
        <!-- begin_recommend_room -->
        <div class="row row_recommend">
            <div class="recommendroom custom_box">
                <section class="wow animated animatedFadeInUp fadeInUp">

                    <h3 class="section-title"><a href="#">Danh Sách Phòng</a></h3>
                    <div class="blog-slider-container room_items outer-top-xs p-l0 p-r0">
...
<!--                                                </div>-->
        ...
        <!-- end_recommend_room -->
        <!-- begin_new_room -->
        <section class="resize_style section latest-blog outer-bottom-vs wow animated animatedFadeInUp fadeInUp newscat mg-style mg-pd-0">
            <h3 class="section-title">Tin mới nhất</h3>
            <div class="blog-slider-container outer-top-xs">
                <div id="blog-slider" class="owl-carousel blog-slider-s custom-carousel">
                    <?php foreach($listArticle as $key=>$item): ?>
                    <div class="item">
                        <div class="blog-post">
        ...
        <section class="full-row bg-gray p-t50 p-b45 p-l0 p-r0">
            <div class="container">
                <div class="row">
                    <div class="col-xs-24">
                        <div class="main-title-area text-center mb-5">
                            <h2 class="title left-right-line mb-4">Dịch vụ của chúng tôi</h2>
                            <span class="subtext text-secondary"><i class="fa fa-gg" aria-hidden="true"></i></span> </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-16 col-sm-24 offset-4">
                    ...
                    <div id="contactButton">
                        ...
                        <div class="clearfix">
                            <div data-cs="f3d5d4b112a6e40daee3389367729ba2"></div>
                        </div>
                    </div>
...
<div id="guestLogin_nv29" class="hidden">
    <div class="page panel panel-default bg-lavender box-shadow">
        <div class="panel-body">
            <h3 id="loginBarHandle" class="h3_login">
                <label for="LoginControl"><a href="#" class="OverlayTrigger concealed noOutline">Thành viên đăng nhập</a></label>
...
<script type="text/javascript">
    ...
    var list_error = 'Vì lý do nào đó hệ thống không thể đáp ứng yêu cầu của quý khách lúc này. Vui lòng liên hệ với người quản trị để biết thêm thông tin. Xin cảm ơn!';
...
<script type="text/javascript">
    $(document).ready(function() {
        jQuery(".blog-slider-s").owlCarousel({
            items : '3',
            itemsMobile : [ 500, 1 ],
            itemsTablet : [ 768, 2 ],
            itemsDesktopSmall : [ 979, 3 ],
...
<!-- Mirrored from bookinghotel.mynukeviet.com/vi/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Oct 2021 14:37:57 GMT -->
</html>