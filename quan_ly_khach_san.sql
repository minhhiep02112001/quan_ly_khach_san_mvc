...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 15, 2021 lúc 06:48 AM
...
(5, 'Chu Minh Hiệp', 'chuminhhiep02112001@gmail.com', '0394599501', 'e10adc3949ba59abbe56e057f20f883e', 0, NULL, '2021-10-08 03:30:15', '2021-10-08 03:30:15'),
...
CREATE TABLE `orders` (
  ...
  `start` date NOT NULL,
  `end` date NOT NULL,
  `sum_day` tinyint(4) NOT NULL DEFAULT 0,
...
INSERT INTO `orders` (`id`, `code`, `user_id`, `name`, `email`, `phone`, `total`, `status`, `start`, `end`, `sum_day`, `contents`, `payment`, `created_at`, `updated_at`) VALUES
(2, 'DP1634215198', 48, 'Chu Minh Hiệp IT', 'user@test.com', '0394599002', 1800000, 4, '2021-10-21', '2021-10-26', 6, 'do chúng tôi ko đi du lịch nữa', 0, '2021-10-14 12:39:58', NULL),
(4, 'DP1634271027', 48, 'Chu Minh Hiệp IT', 'user@test.com', '0394599002', 1800000, 2, '2021-10-21', '2021-10-26', 6, '', 1, '2021-10-15 04:10:27', NULL),
(5, 'DP1634272718', 48, 'Chu Minh Hiệp IT', 'user@test.com', '0394599002', 150000, 0, '2021-10-15', '2021-10-15', 1, '', 0, '2021-10-15 04:38:38', NULL);
...
INSERT INTO `payment` (`id`, `p_order_id`, `order_code`, `p_user_id`, `p_money`, `p_note`, `p_vnp_response_code`, `p_code_vnpay`, `p_code_bank`, `p_time`, `created_at`, `updated_at`) VALUES
(3, 4, 'DP1634271027', 48, 180000000, 'Thanh toán hóa đơn phí dich vụ', '00', '13605023', 'NCB', '2021-10-15 11:13:17', NULL, NULL);
...
(2, 'Căn hộ 822 phòng ngủ 2 người', 'can-ho-822-phong-ngu-2-nguoi', '     sdsadsad                                    \r\n                                ', '<p>sadsada</p>\r\n', './public/upload/user/20181204_142321_001.jpg', 200000, 2, 1, '2021-10-07 21:25:41', '2021-10-07 21:50:37'),
...
(48, 'Chu Minh Hiệp IT', 'user@test.com', '0394599002', 'e10adc3949ba59abbe56e057f20f883e', NULL, 1, NULL, NULL),
(49, 'KH1', 'user@test.com.vn', '0394599519', 'e10adc3949ba59abbe56e057f20f883e', NULL, 1, NULL, NULL);
